...
const toys = [
  { name: "Bamba the Poodle", image: bambaImg, description: "The original fluffy poodle that started it all", price: "£19.99", tag: "Best Seller", paypalLink: "https://buy.stripe.com/bJe28rdvBbdC5bP0sDdUY01" },
